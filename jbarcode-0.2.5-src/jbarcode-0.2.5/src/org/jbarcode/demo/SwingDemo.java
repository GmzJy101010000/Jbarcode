        ...
        try {
            ...
            setSize(400, 300);
            {
                
                {
                    ...
                    jbc.setBarHeigth(2.1);
                    jbc.setCheckSum("4");
                    jbc.setXDimension(0.03);
                ...
                }
                {
                    ...
                    jButton2.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent evt) {
                            jbc.setBarHeigth(Double.parseDouble(jTextField2.getText()));
                            try {
