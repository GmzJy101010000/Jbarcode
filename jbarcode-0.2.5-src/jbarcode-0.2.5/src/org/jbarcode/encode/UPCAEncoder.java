...
public class UPCAEncoder implements BarcodeEncoder {
    ...
    private EAN13Encoder ean13;
    
    private UPCAEncoder(){
        ean13 = EAN13Encoder.getInstance();
    }
	...
	public String computeCheckSum(String texto) throws InvalidAtributeException {
		return ean13.computeCheckSum("0" + texto);
	}
    
    public static String convertUPCAtoUPCE(String upca) throws InvalidAtributeException{
